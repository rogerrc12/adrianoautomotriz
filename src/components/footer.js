      ...
      <div className="row">
        <div className="col-lg-4 col-md-6">
          <div className="about-content">
            ...
            />
            <p>
              Ofrecemos a nuestros clientes más de 5000 productos multimarca
              para el mantenimiento y seguridad de vehículos livianos y pesados.
            </p>
          </div>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="news-letter">
            ...
            <p>
              Mantente al dia de nuestras promociones y descuentos en nuestro
              stock.
            </p>
          ...
          <div className="col-lg-6 col-md-12">
            <div className="text-lg-left text-center">
              <p>
                ...
                <a
                  href="http://www.ikigaimarketer.com/"
                  target="_blank"
